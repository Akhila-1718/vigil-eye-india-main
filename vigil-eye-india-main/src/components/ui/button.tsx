  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-[0_0_15px_hsl(var(--success)/0.3)]",
        ...
        glow: "bg-primary/20 text-primary border border-primary/50 hover:bg-primary/30 shadow-[0_0_20px_hsl(var(--primary)/0.3)]",
        danger: "bg-destructive/20 text-destructive border border-destructive/50 hover:bg-destructive/30 shadow-[0_0_20px_hsl(var(--destructive)/0.4)]",
      },
      size: {
